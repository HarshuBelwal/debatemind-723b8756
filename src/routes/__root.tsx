...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DebateMind — AI Study Group · Quiz Battle · Argument Arena" },
      { property: "og:description", content: "Debate AI, crush quizzes, and build sharper arguments. Level up from Novice Thinker to Socrates Reborn in DebateMind." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "DebateMind — AI Study Group · Quiz Battle · Argument Arena" },
      { name: "twitter:description", content: "Debate AI, crush quizzes, and build sharper arguments. Level up from Novice Thinker to Socrates Reborn in DebateMind." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/9bd24cf3-ce36-4e99-a007-7b36a135e7a1" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/9bd24cf3-ce36-4e99-a007-7b36a135e7a1" },
    ],
    links: [
